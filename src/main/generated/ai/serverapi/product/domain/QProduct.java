...
public class QProduct extends EntityPathBase<Product> {
    ...
    private static final long serialVersionUID = 142424417L;
    ...
    public QProduct(Class<? extends Product> type, PathMetadata metadata, PathInits inits) {
        ...
        this.seller = inits.isInitialized("seller") ? new ai.serverapi.member.domain.QSeller(forProperty("seller"), inits.get("seller")) : null;
    }
