...
public class TokenProvider {
    ...
    public LoginRecord generateTokenDto(final Authentication authenticate) {
        // 권한 가져오고
        ...
        return new LoginRecord(TYPE, accessToken, refreshToken, accessTokenExpiresIn.getTime(),
            null);
    }
